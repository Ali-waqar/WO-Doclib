...
var Sentry = function(t) {
    ...
    t.Severity = void 0, (e = t.Severity || (t.Severity = {})).Fatal = "fatal", e.Error = "error", e.Warning = "warning", e.Log = "log", e.Info = "info", e.Debug = "debug", e.Critical = "critical";
    var s = {};
    ...
    function E(t, n) {
        try {
            for (var r = t, e = [], i = 0, o = 0, u = " > ".length, a = void 0; r && i++ < 5 && !("html" === (a = _(r, n)) || i > 1 && o + e.length * u + a.length >= 80);) e.push(a), o += a.length, r = r.parentNode;
    ...
    function _(t, n) {
        ...
        if (c && c.length) c.forEach((function(t) {
            ...
            for (e = r.split(/\s+/), u = 0; u < e.length; u++) s.push("." + e[u]);
        var f = ["type", "name", "title", "alt"];
        for (u = 0; u < f.length; u++) i = f[u], (o = a.getAttribute(i)) && s.push("[" + i + '="' + o + '"]');
        return s.join("")
    }
    ...
    var D = ["fatal", "error", "warning", "log", "info", "debug", "critical"],
        N = (c(), ["debug", "info", "warn", "error", "log", "assert"]);
    ...
    function q(t) {
        ...
        N.forEach((function(t) {
            ...
            t in n.console && i && (e[t] = r[t], r[t] = i)
        }));
        try {
            return t()
        } finally {
    ...
    function X(t) {
        ...
        if (v(t)) n = i({
            ...
            }, z(r)), "undefined" != typeof CustomEvent && x(t, CustomEvent) && (n.detail = r.detail)
        }
        return n
    }
    ...
    function F(t) {
        try {
            return n = t, "undefined" != typeof Element && x(n, Element) ? E(t) : Object.prototype.toString.call(t)
        } catch (t) {
            return "<unknown>"
        }
        var n
    ...
    function W(t) {
        ...
        return -1 === r.indexOf("captureMessage") && -1 === r.indexOf("captureException") || (n = n.slice(1)), -1 !== e.indexOf("sentryWrapped") && (n = n.slice(0, -1)), n.slice(0, 50).map((function(t) {
            return i(i({}, t), {
        ...
        if (!nt[t]) switch (nt[t] = !0, t) {
            ...
            case "dom":
                ! function() {
                    ...
                    var t = it.bind(null, "dom"),
                        n = ct(t, !0);
                    Z.document.addEventListener("click", n, !1), Z.document.addEventListener("keypress", n, !1), ["EventTarget", "Node"].forEach((function(n) {
                            ...
                            return function(n, r, e) {
                                if ("click" === n || "keypress" == n) try {
                                    var i = this,
                                        ...
                                        u = o[n];
                                    u && (u.refCount -= 1, u.refCount <= 0 && (t.call(this, n, u.handler, e), u.handler = void 0, delete o[n]), 0 === Object.keys(o).length && delete i.__sentry_instrumentation_handlers__)
                                } catch (t) {}
            ...
            case "xhr":
                ! function() {
                    ...
                    L(t, "open", (function(t) {
                        ...
                        return function() {
                            for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                            return this.__sentry_xhr__ && void 0 !== n[0] && (this.__sentry_xhr__.body = n[0]), it("xhr", {
                                args: n,
                                startTimestamp: Date.now(),
                                xhr: this
                            }), t.apply(this, n)
            ...
            case "fetch":
                ! function() {
                    if (! function() {
                            if (!G()) return !1;
                            var t = c();
                            if (V(t.fetch)) return !0;
                            var n = !1,
                                r = t.document;
                            if (r && "function" == typeof r.createElement) try {
                                var e = r.createElement("iframe");
                                e.hidden = !0, r.head.appendChild(e), e.contentWindow && e.contentWindow.fetch && (n = V(e.contentWindow.fetch)), r.head.removeChild(e)
                            } catch (t) {}
                            return n
                        }()) return;
                    L(Z, "fetch", (function(t) {
                        return function() {
                            ...
                            return it("fetch", i({}, e)), t.apply(Z, n).then((function(t) {
            ...
            case "history":
                ! function() {
                    ...
                    }, L(Z.history, "pushState", n), L(Z.history, "replaceState", n)
                }();
                break;
            case "error":
                ft = Z.onerror, Z.onerror = function(t, n, r, e, i) {
                    return it("error", {
                        column: e,
                        error: i,
                        line: r,
            ...
            case "unhandledrejection":
                ht = Z.onunhandledrejection, Z.onunhandledrejection = function(t) {
                    return it("unhandledrejection", t), !ht || ht.apply(this, arguments)
                };
                break;
            default:
                return
    ...
    function ot(t) {
        return void 0 === t && (t = []), "Request" in Z && x(t[0], Request) && t[0].method ? String(t[0].method).toUpperCase() : t[1] && t[1].method ? String(t[1].method).toUpperCase() : "GET"
    }

    function ut(t) {
        return void 0 === t && (t = []), "string" == typeof t[0] ? t[0] : "Request" in Z && x(t[0], Request) ? t[0].url : String(t[0])
    }
    var at, st;
            ...
            function(r) {
                if (r && st !== r && ! function(t) {
                    ...
                    (void 0 === at || function(t, n) {
                        ...
                        name: e,
                        global: n
                    }), st = r), clearTimeout(at), at = Z.setTimeout((function() {
                        at = void 0
                    }), 1e3)
                }
            }
    ...
    function xt(t, n, r, e, i) {
        var o, a;
        void 0 === r && (r = 1 / 0), void 0 === e && (e = 1 / 0), void 0 === i && (o = "function" == typeof WeakSet, a = o ? new WeakSet : [], i = [function(t) {
        ...
        if (null === n || ["number", "boolean", "string"].includes(typeof n) && ("number" != typeof(s = n) || s == s)) return n;
        var l = function(t, n) {
            try {
    ...
    var St = function() {
        function t(t) {
            ...
            this.i = 0, this.o = [], this.u = function(t) {
                ...
                0 === n.i && (g(r) ? r.then(n.u, n.v) : (n.i = t, n.l = r, n.p()))
            }, this.p = function() {
                if (0 !== n.i) {
                    var t = n.o.slice();
    ...
    function kt(t) {
        ...
        return {
            $: n,
            add: function(e) {
                if (!(void 0 === t || n.length < t)) return _t(new k("Not adding Promise due to buffer limit reached."));
                var i = e();
    ...
    function Ct(t, n, r) {
        return void 0 === r && (r = Date.now()), At(t, n) > r
    }
    ...
    var Ut = function() {
        function t() {
            this.m = !1, this.g = [], this._ = [], this.S = [], this.k = {}, this.j = {}, this.O = {}, this.T = {}, this.R = {}
        }
        return t.clone = function(n) {
            var r = new t;
            return n && (r.S = a(n.S), r.j = i({}, n.j), r.O = i({}, n.O), r.T = i({}, n.T), r.k = n.k, r.D = n.D, r.N = n.N, r.q = n.q, r.M = n.M, r.I = n.I, r._ = a(n._), r.A = n.A), r
        }, t.prototype.addScopeListener = function(t) {
            this.g.push(t)
        }, t.prototype.addEventProcessor = function(t) {
            return this._.push(t), this
        }, t.prototype.setUser = function(t) {
            return this.k = t || {}, this.q && this.q.update({
                user: t
            }), this.C(), this
            ...
            return this.I = t, this.C(), this
        }, t.prototype.setLevel = function(t) {
            return this.D = t, this.C(), this
            ...
            return t ? this.q = t : delete this.q, this.C(), this
            ...
            return n instanceof t ? (this.j = i(i({}, this.j), n.j), this.O = i(i({}, this.O), n.O), this.T = i(i({}, this.T), n.T), n.k && Object.keys(n.k).length && (this.k = n.k), n.D && (this.D = n.D), n.I && (this.I = n.I), n.A && (this.A = n.A)) : b(n) && (n = n, this.j = i(i({}, this.j), n.tags), this.O = i(i({}, this.O), n.extra), this.T = i(i({}, this.T), n.contexts), n.user && (this.k = n.user), n.level && (this.D = n.level), n.fingerprint && (this.I = n.fingerprint), n.requestSession && (this.A = n.requestSession)), this
        }, t.prototype.clear = function() {
            return this.S = [], this.j = {}, this.O = {}, this.k = {}, this.T = {}, this.D = void 0, this.M = void 0, this.I = void 0, this.A = void 0, this.N = void 0, this.q = void 0, this.C(), this
            ...
            return this.S = a(this.S, [e]).slice(-r), this.C(), this
        }, t.prototype.clearBreadcrumbs = function() {
            return this.S = [], this.C(), this
        }, t.prototype.applyToEvent = function(t, n) {
            if (this.O && Object.keys(this.O).length && (t.extra = i(i({}, this.O), t.extra)), this.j && Object.keys(this.j).length && (t.tags = i(i({}, this.j), t.tags)), this.k && Object.keys(this.k).length && (t.user = i(i({}, this.k), t.user)), this.T && Object.keys(this.T).length && (t.contexts = i(i({}, this.T), t.contexts)), this.D && (t.level = this.D), this.M && (t.transaction = this.M), this.N) {
                t.contexts = i({
            ...
            return this.L(t), t.breadcrumbs = a(t.breadcrumbs || [], this.S), t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0, t.sdkProcessingMetadata = this.R, this.U(a(Pt(), this._), t, n)
        }, t.prototype.setSDKProcessingMetadata = function(t) {
            return this.R = i(i({}, this.R), t), this
        }, t.prototype.U = function(t, n, r, e) {
            var o = this;
            return void 0 === e && (e = 0), new St((function(u, a) {
                var s = t[e];
            ...
            t.fingerprint = t.fingerprint ? Array.isArray(t.fingerprint) ? t.fingerprint : [t.fingerprint] : [], this.I && (t.fingerprint = t.fingerprint.concat(this.I)), t.fingerprint && !t.fingerprint.length && delete t.fingerprint
        }, t
    }();
    ...
    var Xt = function() {
            ...
            return t.prototype.update = function(t) {
                if (void 0 === t && (t = {}), t.user && (!this.ipAddress && t.user.ip_address && (this.ipAddress = t.user.ip_address), this.did || t.did || (this.did = t.user.id || t.user.email || t.user.username)), this.timestamp = t.timestamp || qt(), t.ignoreDuration && (this.ignoreDuration = t.ignoreDuration), t.sid && (this.sid = 32 === t.sid.length ? t.sid : vt()), void 0 !== t.init && (this.init = t.init), !this.did && t.did && (this.did = "" + t.did), "number" == typeof t.started && (this.started = t.started), this.ignoreDuration) this.duration = void 0;
        ...
        Ft = function() {
            function t(t, n, r) {
                void 0 === n && (n = new Ut), void 0 === r && (r = 4), this.P = r, this.H = [{}], this.getStackTop().scope = n, t && this.bindClient(t)
            }
            return t.prototype.isOlderThan = function(t) {
                ...
                return "transaction" !== t.type && (this.X = r), this.F("captureEvent", t, i(i({}, n), {
                    event_id: r
                })), r
    ...
    function $t() {
        var t, n = zt();
        return (t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !Wt(n).isOlderThan(4) || Jt(n, new Ft), Wt(n)
    }
    ...
    function on(t) {
        ...
        return function(t) {
            ...
            })), en(r)) : "function" == typeof r && (e = r(e), e = Array.isArray(e) ? e : [e]);
            ...
            n[t.name] = t,
                function(t) {
                    -1 === rn.indexOf(t.name) && (t.setupOnce(Ht, $t), rn.push(t.name))
                }(t)
        })), U(n, "initialized", !0), n
    }
    var un = function() {
        function t(t, n) {
            this.J = {}, this.K = 0, this.G = new t(n), this.V = n, n.dsn && (this.Y = R(n.dsn))
        }
        return t.prototype.captureException = function(t, n, r) {
            ...
            this.rt() && ("string" != typeof t.release || (this.et(t), t.update({
                init: !1
            })))
            ...
            return t.contexts && t.contexts.trace && (e.contexts.trace = t.contexts.trace), e.sdkProcessingMetadata = i(i({}, e.sdkProcessingMetadata), {
            ...
            if (!this.rt()) return _t(new k("SDK not enabled, will not capture event."));
            var c = "transaction" === t.type;
            return !c && "number" == typeof u && Math.random() > u ? (s("sample_rate", "event"), _t(new k("Discarding event because it's not included in the random sample (sampling rate = " + u + ")"))) : this.ut(t, r, n).then((function(r) {
                if (null === r) throw s("event_processor", t.type || "event"), new k("An event processor returned null, will not send event.");
                ...
                if (null === n) throw s("before_send", t.type || "event"), new k("`beforeSend` returned `null`, will not send event.");
                var i = r && r.getSession && r.getSession();
                return !c && i && e.ot(i, n), e.ft(n), n
    ...
    function sn(t, n) {
        return n ? (t.sdk = t.sdk || {}, t.sdk.name = t.sdk.name || n.name, t.sdk.version = t.sdk.version || n.version, t.sdk.integrations = a(t.sdk.integrations || [], n.integrations || []), t.sdk.packages = a(t.sdk.packages || [], n.packages || []), t) : t
    }
    ...
    var fn = function() {
        ...
        hn = function() {
            ...
            return t.prototype.eventFromException = function(t, n) {
                ...
                if (this.lt && this.V.dsn && this.V._experiments && this.V._experiments.newTransport) {
                    var n = function(t, n) {
                        var r = an(n),
                            ...
                            u = o.method,
                            a = o.rate;
                        return sn(t, n.metadata.sdk), t.tags = t.tags || {}, t.extra = t.extra || {}, t.sdkProcessingMetadata && t.sdkProcessingMetadata.baseClientNormalized || (t.tags.skippedNormalization = !0, t.extra.normalizeDepth = t.sdkProcessingMetadata ? t.sdkProcessingMetadata.normalizeDepth : "unset"), delete t.sdkProcessingMetadata, Mt(i(i({
                            event_id: t.event_id,
                            sent_at: (new Date).toISOString()
                        }, r && {
                            sdk: r
                ...
                } else this.vt.sendEvent(t).then(null, (function(t) {}))
            }, t.prototype.sendSession = function(t) {
                if (this.vt.sendSession)
                    if (this.lt && this.V.dsn && this.V._experiments && this.V._experiments.newTransport) {
                        var n = u(cn(t, Vt(this.V.dsn, this.V.yt, this.V.tunnel)), 1)[0];
                        this.lt.send(n).then(null, (function(t) {}))
                    } else this.vt.sendSession(t).then(null, (function(t) {}))
            }, t.prototype.getTransport = function() {
                return this.vt
                ...
                return Ct(e, o) ? _t({
                    ...
                    return n(a).then((function(t) {
                        var n = t.body,
                            ...
                            i = t.reason,
                            u = Ot(t.statusCode);
                        return r && (e = Lt(e, r)), "success" === u ? Et({
                            status: u,
                            reason: i
                        }) : _t({
                            status: u,
    ...
    function gn(t) {
        try {
            if (t.stacktrace) return wn(t.stacktrace.frames);
            var n;
            try {
    ...
    var Sn = /^\s*at (?:(.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        ...
        Rn = [50, function(t) {
            ...
            if (r) {
                ...
                var i = r[3],
                    o = r[1] || En;
                return o = (n = u(Cn(o, i), 2))[0], _n(i = n[1], o, r[4] ? +r[4] : void 0, r[5] ? +r[5] : void 0)
            }
        }],
    ...
    function Fn(n, r, e) {
        ...
        return mt(i), i.level = t.Severity.Error, r && r.event_id && (i.event_id = r.event_id), Et(i)
    }

    function zn(n, r, e, i) {
        void 0 === r && (r = t.Severity.Info);
        var o = $n(n, e && e.syntheticException || void 0, i);
        return o.level = r, e && e.event_id && (o.event_id = e.event_id), Et(o)
    }

    function Bn(t, n, r, e) {
        var o;
        if (l(t) && t.error) return Un(t.error);
        if (y(t) || d(t, "DOMException")) {
            var u = t;
            if ("stack" in t) o = Un(t);
            else {
    ...
    function Kn() {
        if (Wn) return Wn;
        if (V(Jn.fetch)) return Wn = Jn.fetch.bind(Jn);
        var t = Jn.document,
            n = Jn.fetch;
    ...
    function Gn(t, n) {
        if ("[object Navigator]" === Object.prototype.toString.call(Jn && Jn.navigator) && "function" == typeof Jn.navigator.sendBeacon) return Jn.navigator.sendBeacon.bind(Jn.navigator)(t, n);
        if (G()) {
            var r = Kn();
            r(t, {
                body: n,
    ...
    var Qn = c(),
        Yn = function() {
            function t(t) {
                var n = this;
                this.options = t, this.bt = kt(30), this.wt = {}, this.gt = {}, this.xt = Vt(t.dsn, t.yt, t.tunnel), this.url = tn(this.xt.dsn), this.options.sendClientReports && Qn.document && Qn.document.addEventListener("visibilitychange", (function() {
            ...
            return t.prototype.sendEvent = function(t) {
                return this._t(function(t, n) {
                    var r, e = an(n),
                        ...
                        s = a.method,
                        c = a.rate;
                    sn(t, n.metadata.sdk), t.tags = t.tags || {}, t.extra = t.extra || {}, t.sdkProcessingMetadata && t.sdkProcessingMetadata.baseClientNormalized || (t.tags.skippedNormalization = !0, t.extra.normalizeDepth = t.sdkProcessingMetadata ? t.sdkProcessingMetadata.normalizeDepth : "unset"), delete t.sdkProcessingMetadata;
                    try {
                        r = JSON.stringify(t)
                    } catch (n) {
                ...
                if (this.options.sendClientReports) {
                    var t = this.gt;
                    if (this.gt = {}, Object.keys(t).length) {
                        var n, r, e, i = nn(this.xt.dsn, this.xt.tunnel),
                            ...
                            a = (n = o, Mt((r = this.xt.tunnel && O(this.xt.dsn)) ? {
                                dsn: r
                            } : {}, [
                                [{
                                    type: "client_report"
                ...
                var n = t.requestType,
                    ...
                    o = t.reject,
                    u = Ot(r.status);
                this.wt = Lt(this.wt, e), this.kt(n), "success" !== u ? o(r) : i({
                    status: u
                })
        ...
        Zn = function(t) {
            ...
            return r(n, t), n.prototype._t = function(t, n) {
                var r = this;
                if (this.kt(t.type)) return this.recordLostEvent("ratelimit_backoff", t.type), Promise.reject({
                    event: n,
                    type: t.type,
                ...
                return void 0 !== this.options.fetchParameters && Object.assign(e, this.options.fetchParameters), void 0 !== this.options.headers && (e.headers = this.options.headers), this.bt.add((function() {
        ...
        tr = function(t) {
            ...
            return r(n, t), n.prototype._t = function(t, n) {
                var r = this;
                return this.kt(t.type) ? (this.recordLostEvent("ratelimit_backoff", t.type), Promise.reject({
                    event: n,
                    type: t.type,
                    reason: "Transport for " + t.type + " requests locked till " + this.jt(t.type) + " due to too many requests.",
                    status: 429
                    ...
                    return new St((function(n, e) {
                        ...
                        for (var o in i.onreadystatechange = function() {
                            ...
                            }, i.open("POST", t.url), r.options.headers) Object.prototype.hasOwnProperty.call(r.options.headers, o) && i.setRequestHeader(o, r.options.headers[o]);
                        i.send(t.body)
                    }))
                })).then(void 0, (function(n) {
                    throw n instanceof k ? r.recordLostEvent("queue_overflow", t.type) : r.recordLostEvent("network_error", t.type), n
    ...
    var er = Object.freeze({
        ...
        ir = function(n) {
            ...
            return r(e, n), e.prototype.eventFromException = function(t, n) {
                ...
                return void 0 === r && (r = t.Severity.Info), zn(n, r, e, this.V.attachStacktrace)
                ...
                var t = i(i({}, this.V.transportOptions), {
                    ...
                    e = nn(r.dsn, r.tunnel);
                if (this.V.transport) return new this.V.transport(t);
                if (G()) {
    ...
    function cr(t, n, r) {
        ...
        var sentryWrapped = function() {
            ...
            try {
                ...
                throw sr(), Gt((function(r) {
                    r.addEventProcessor((function(t) {
                        return n.mechanism && (pt(t, void 0, void 0), mt(t, n.mechanism)), t.extra = i(i({}, t.extra), {
                            arguments: e
                        }), t
                    })), captureException(t)
                })), t
        ...
        P(sentryWrapped, t), U(t, "__sentry_wrapped__", sentryWrapped);
        try {
    ...
    function fr(t) {
        if (void 0 === t && (t = {}), or.document && t.eventId && t.dsn) {
            ...
            n.async = !0, n.src = function(t, n) {
                ...
                for (var o in n)
                    if ("dsn" !== o)
                        if ("user" === o) {
                            if (!n.user) continue;
                            n.user.name && (i += "&name=" + encodeURIComponent(n.user.name)), n.user.email && (i += "&email=" + encodeURIComponent(n.user.email))
        ...
        et("error", (function(n) {
            ...
            if (e.getIntegration(hr)) {
                ...
                if (!(ar() || f && f.__sentry_own_request__)) {
                    ...
                    h.level = t.Severity.Error, yr(e, f, h, "onerror")
                }
            }
        }))
    }
    ...
    function dr() {
        et("unhandledrejection", (function(n) {
            ...
            if (e.getIntegration(hr)) {
                ...
                if (ar() || o && o.__sentry_own_request__) return !0;
                var a = m(o) ? {
                    exception: {
                        values: [{
                ...
                a.level = t.Severity.Error, yr(e, o, a, "onunhandledrejection")
            }
        }))
    }
    ...
    var mr = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
        br = function() {
            ...
            return t.prototype.setupOnce = function() {
                var t = c();
                this.V.setTimeout && L(t, "setTimeout", wr), this.V.setInterval && L(t, "setInterval", wr), this.V.requestAnimationFrame && L(t, "requestAnimationFrame", gr), this.V.XMLHttpRequest && "XMLHttpRequest" in t && L(XMLHttpRequest.prototype, "send", xr);
            ...
            return i.forEach((function(t) {
                t in e && "function" == typeof e[t] && L(e, t, (function(n) {
                    var r = {
                        ...
                        e = H(n);
                    return e && (r.mechanism.data.handler = K(e)), cr(n, r)
                }))
            })), t.apply(this, n)
        }
    }
    ...
    var _r = function() {
        ...
        return t.prototype.addSentryBreadcrumb = function(t) {
            ...
            this.V.console && et("console", Sr), this.V.dom && et("dom", function(t) {
                function n(n) {
                ...
                return n
            }(this.V.dom)), this.V.xhr && et("xhr", kr), this.V.fetch && et("fetch", jr), this.V.history && et("history", Or)
        }, t.id = "Breadcrumbs", t
    }();
    ...
    function Sr(t) {
        ...
        if ("assert" === t.level) {
            ...
            n.message = "Assertion failed: " + (A(t.args.slice(1), " ") || "console.assert"), n.data.arguments = t.args.slice(1)
        }
        $t().addBreadcrumb(n, {
            input: t.args,
            level: t.level
    ...
    function Or(t) {
        var n = c(),
            ...
            o = dt(r),
            u = dt(e);
        o.path || (o = i), i.protocol === u.protocol && i.host === u.host && (e = u.relative), i.protocol === o.protocol && i.host === o.host && (r = o.relative), $t().addBreadcrumb({
            category: "navigation",
            data: {
                from: r,
                to: e
    ...
    var Tr = function() {
        function t(n) {
            void 0 === n && (n = {}), this.name = t.id, this.Rt = n.key || "cause", this.Dt = n.limit || 5
        }
        return t.prototype.setupOnce = function() {
            Ht((function(n, r) {
    ...
    var Lr = Object.freeze({
        ...
        Ur = function(t) {
            function n(n) {
                void 0 === n && (n = {});
                return n.yt = n.yt || {}, n.yt.sdk = n.yt.sdk || {
            ...
            return r(n, t), n.prototype.showReportDialog = function(t) {
                void 0 === t && (t = {}), c().document && this.rt() && fr(i(i({}, t), {
    ...
    return t.BrowserClient = Ur, t.Hub = Ft, t.Integrations = zr, t.SDK_NAME = "sentry.javascript.browser", t.SDK_VERSION = yn, t.Scope = Ut, t.Session = Xt, t.Transports = er, t.addBreadcrumb = function(t) {
        Kt("addBreadcrumb", t)
    }, t.addGlobalEventProcessor = Ht, t.captureEvent = function(t) {
        ...
        Kt("configureScope", t)
    }, t.defaultIntegrations = Pr, t.eventFromException = Fn, t.eventFromMessage = zn, t.flush = function(t) {
        var n = $t().getClient();
        return n ? n.flush(t) : Et(!1)
    }, t.forceLoad = function() {}, t.getCurrentHub = $t, t.getHubFromCarrier = Wt, t.init = function(t) {
        if (void 0 === t && (t = {}), void 0 === t.defaultIntegrations && (t.defaultIntegrations = Pr), void 0 === t.release) {
            var n = c();
        ...
        void 0 === t.autoSessionTracking && (t.autoSessionTracking = !0), void 0 === t.sendClientReports && (t.sendClientReports = !0),
            function(t, n) {
                ...
                var i = new t(n);
                r.bindClient(i)
            }(Ur, t), t.autoSessionTracking && function() {
                if (void 0 === c().document) return;
                var t = $t();
                if (!t.captureSession) return;
                Hr(t), et("history", (function(t) {
                    var n = t.from,
                        r = t.to;
                    void 0 !== n && n !== r && Hr($t())
                }))
            }()
    }, t.injectReportDialog = fr, t.lastEventId = function() {
        return $t().lastEventId()
    }, t.makeMain = Bt, t.onLoad = function(t) {
        t()
    ...
    }, t.withScope = Gt, t.wrap = function(t) {
        return cr(t)()
    }, t
}({});
